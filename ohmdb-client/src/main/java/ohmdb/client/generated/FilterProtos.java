...
public final class FilterProtos {
  ...
  public interface ColumnPaginationFilterOrBuilder
    ...
    /**
     * <code>optional bytes columnOffset = 3;</code>
     */
          ...
          switch (tag) {
            ...
            case 18: {
              if (!((mutable_bitField0_ & 0x00000002) == 0x00000002)) {
                filters_ = new java.util.ArrayList<ohmdb.client.generated.HBaseProtos.Filter>();
                mutable_bitField0_ |= 0x00000002;
              }
              filters_.add(input.readMessage(ohmdb.client.generated.HBaseProtos.Filter.PARSER, extensionRegistry));
              break;
            }
          }
        }
